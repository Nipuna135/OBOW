...
const mlogo = "/assets/mlogo-BjsqQMQ9.jpg";
const navItems = [
  { to: "/", label: "Home" },
  { to: "/about", label: "About" },
  { to: "/dharma", label: "Dharma" },
...
function LotusMark({ className = "" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-20 w-20 rounded-full overflow-hidden shadow-sm bg-sky-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "img",
    {
      src: mlogo,
      alt: "One Buddha One World Logo",
      className: `h-full w-full object-cover scale-110 ${className}`
    }
  ) });
}
function Header() {
  const [open, setOpen] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 backdrop-blur-md bg-background/80 border-b border-border/50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-10 h-20 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-3 group", onClick: () => setOpen(false), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LotusMark, { className: "w-8 h-8 text-primary group-hover:text-accent transition-colors" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-serif text-lg text-primary", children: "One Buddha" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-serif text-lg text-accent -mt-1", children: "One World" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden lg:flex items-center gap-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            to: "/contact",
            className: "px-5 py-2.5 rounded-full bg-gradient-gold text-accent-foreground text-sm font-medium shadow-soft hover:shadow-glow transition-all",
            children: "Join Us"
          }
        )
      ] }),
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "lg:hidden border-t border-border/50 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col px-6 py-4 gap-1", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: item.to,
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-gradient-maroon text-primary-foreground/90 mt-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-10 py-16 grid md:grid-cols-4 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LotusMark, { className: "w-9 h-9 text-accent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-serif text-2xl", children: "One Buddha · One World" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed text-primary-foreground/70 max-w-md", children: "A global movement uniting humanity through the timeless wisdom of the Dharma. May all beings be peaceful, happy, and free." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-accent text-sm uppercase tracking-widest mb-4", children: "Explore" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/dharma", className: "hover:text-accent transition-colors", children: "Teachings" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/events", className: "hover:text-accent transition-colors", children: "Events" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/media", className: "hover:text-accent transition-colors", children: "Media" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/books", className: "hover:text-accent transition-colors", children: "Books" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-accent text-sm uppercase tracking-widest mb-4", children: "Connect" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", className: "hover:text-accent transition-colors", children: "About Us" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "hover:text-accent transition-colors", children: "Contact" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground/60", children: "English · සිංහල · ไทย" }) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-primary-foreground/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-10 py-6 text-xs text-primary-foreground/60 flex flex-col md:flex-row justify-between gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " One Buddha One World. Sharing the Dharma freely."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Sabbe sattā bhavantu sukhitattā — May all beings be happy." })
    ] }) })
  ] });
}
function Layout() {
...
const appCss = "/assets/styles-BJQiMFBv.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-serif text-7xl text-primary", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "lotus-divider my-6 text-xs uppercase tracking-[0.3em]", children: "lost path" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-2xl text-foreground", children: "Page not found" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "This page does not exist. Return to the path of the Dharma." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: "/",
        className: "mt-8 inline-flex items-center justify-center rounded-full bg-gradient-gold px-6 py-3 text-sm font-medium text-accent-foreground shadow-soft hover:shadow-glow transition-all",
...
const Route$7 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "One Buddha One World — Uniting the World Through Dharma" },
      { name: "description", content: "A global Buddhist movement sharing the Dharma, hosting international forums, and building a worldwide community of peace and wisdom." },
      { name: "author", content: "One Buddha One World" },
...
const meditationImg = "/assets/meditation-DY5Bpz9B.jpg";
const $$splitComponentImporter$6 = () => import("./media-CG2Otz1x.js");
const Route$6 = createFileRoute("/media")({
  head: () => ({
    meta: [{
      title: "Media — Photos, Videos & Dharma Archive"
    }, {
      name: "description",
      content: "Photo gallery, video teachings, and a living archive of Dharma transmissions from around the world."
    }, {
      property: "og:title",
      content: "Media Library — One Buddha One World"
    }, {
      property: "og:description",
      content: "Photo gallery and video teachings from the global sangha."
    }, {
      property: "og:image",
      content: meditationImg
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const bhantesImg = "/assets/2025-06-06_16-24-06_579756-Da3AQc8P.jpg";
const $$splitComponentImporter$5 = () => import("./events-E5k2LTbc.js");
const Route$5 = createFileRoute("/events")({
  head: () => ({
    meta: [{
      title: "Events — International Dharma Forums"
    }, {
      name: "description",
      content: "Join international Buddhist forums, retreats, and community gatherings from One Buddha One World."
    }, {
      property: "og:title",
      content: "Events & Forums — One Buddha One World"
    }, {
      property: "og:description",
      content: "Global Dharma forums, retreats, and gatherings. Walk the path together."
    }, {
      property: "og:image",
      content: bhantesImg
    }]
...
const lotusImg = "/assets/lotus-Isr98JnX.jpg";
const $$splitComponentImporter$4 = () => import("./dharma-Ce4hcbnD.js");
const Route$4 = createFileRoute("/dharma")({
  head: () => ({
    meta: [{
      title: "Dharma — Teachings & Meditation Guides"
    }, {
      name: "description",
      content: "Explore Buddhist teachings, articles, meditation guides, and audio sessions from teachers around the world."
    }, {
      property: "og:title",
      content: "Dharma Teachings — One Buddha One World"
    }, {
      property: "og:description",
      content: "Articles, meditation guides, and audio teachings to walk the path of the Dharma."
    }, {
      property: "og:image",
      content: lotusImg
    }]
...
const $$splitComponentImporter$3 = () => import("./contact-BcjmemBT.js");
const Route$3 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      title: "Contact & Join — One Buddha One World"
    }, {
      name: "description",
      content: "Get in touch and join the global Dharma community. We welcome you with open hearts."
    }, {
      property: "og:title",
      content: "Contact — One Buddha One World"
    }, {
      property: "og:description",
      content: "Reach out and join our global sangha."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const booksImg = "/assets/books-CPuRIDYe.jpg";
const $$splitComponentImporter$2 = () => import("./books-DpfQNyDQ.js");
const Route$2 = createFileRoute("/books")({
  head: () => ({
    meta: [{
      title: "Books — Buddhist Texts & Publications"
    }, {
      name: "description",
      content: "Browse Buddhist scriptures, contemporary teachings, and publications shared freely by One Buddha One World."
    }, {
      property: "og:title",
      content: "Books — One Buddha One World"
    }, {
      property: "og:description",
      content: "Buddhist texts and publications, freely shared with the global sangha."
    }, {
      property: "og:image",
      content: booksImg
    }]
...
const groupph = "/assets/group-zKNsD2-H.jpg";
const $$splitComponentImporter$1 = () => import("./about-DApG8NQf.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      title: "About — One Buddha One World"
    }, {
      name: "description",
      content: "Our mission, vision, and the global sangha behind One Buddha One World — a movement uniting humanity through the Dharma."
    }, {
      property: "og:title",
      content: "About — One Buddha One World"
    }, {
      property: "og:description",
      content: "A global Buddhist movement rooted in compassion, wisdom, and shared awakening."
    }, {
      property: "og:image",
      content: groupph
    }]
...
const $$splitComponentImporter = () => import("./index-BxDHv6r_.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Join a global Buddhist movement sharing teachings, meditation, and international Dharma events. One Buddha. One World. One Path."
    }, {
      property: "og:title",
      content: "One Buddha One World"
    }, {
      property: "og:description",
      content: "Uniting the world through the Dharma. A global community for teachings, meditation, and peace."
    }]
  }),
...
const DharmaRoute = Route$4.update({
  id: "/dharma",
  path: "/dharma",
  getParentRoute: () => Route$7
});
...
const BooksRoute = Route$2.update({
  id: "/books",
  path: "/books",
  getParentRoute: () => Route$7
});
